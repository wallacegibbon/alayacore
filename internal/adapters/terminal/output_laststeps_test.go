...
func TestLastMaxStepsSavedOnlyOnError(t *testing.T) {
	...
	// Task in progress
	w.handleSystemMsg([]byte(`{"type":"task","data":{"in_progress":true,"current_step":5,"max_steps":10,"context":0,"context_limit":0,"task_error":false}}`))

	// Complete with error — should save
	w.handleSystemMsg([]byte(`{"type":"task","data":{"in_progress":false,"current_step":10,"max_steps":10,"context":0,"context_limit":0,"task_error":true}}`))
...
func TestLastMaxStepsNotDisplayedOnSuccess(t *testing.T) {
	...
	// Task in progress
	w.handleSystemMsg([]byte(`{"type":"task","data":{"in_progress":true,"current_step":7,"max_steps":10,"context":0,"context_limit":0,"task_error":false}}`))

	// Complete without error
	w.handleSystemMsg([]byte(`{"type":"task","data":{"in_progress":false,"current_step":10,"max_steps":10,"context":0,"context_limit":0,"task_error":false}}`))
...
func TestLastMaxStepsResetOnNewTask(t *testing.T) {
	...
	w.handleSystemMsg([]byte(`{"type":"task","data":{"in_progress":true,"current_step":1,"max_steps":20,"context":0,"context_limit":0,"task_error":false}}`))
