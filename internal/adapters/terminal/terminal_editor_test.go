...
func TestGetWindowContentWriteFile(t *testing.T) {
	...
	wb.HandleFunctionEvent(stream.FunctionData{ID: "test-id", IsPlaceholder: false, Name: "write_file", Input: content})
...
func TestGetWindowContentDiff(t *testing.T) {
	...
	wb.HandleFunctionEvent(stream.FunctionData{ID: "test-id", IsPlaceholder: false, Name: "edit_file", Input: content})
