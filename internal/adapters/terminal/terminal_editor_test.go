...
func TestGetWindowContentWriteFile(t *testing.T) {
	...
	wb.HandleToolUseEvent(stream.ToolUseData{ID: "test-id", Name: "write_file", Input: json.RawMessage(content)}, 0)
...
func TestGetWindowContentDiff(t *testing.T) {
	...
	wb.HandleToolUseEvent(stream.ToolUseData{ID: "test-id", Name: "edit_file", Input: json.RawMessage(content)}, 0)
