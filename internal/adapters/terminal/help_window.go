...
func buildHelpItems() []HelpItem {
	...
	items := []HelpItem{
		...
		{ID: nextID(), Key: ":mcp_auth <name> <yes|no>", Description: "Authorize MCP OAuth server", Type: HelpItemCommand},
		{ID: nextID(), Key: ":mcp_init_skip", Description: "Skip current MCP server", Type: HelpItemCommand},
