...
func TestFoldIndicator(t *testing.T) {
	...
	wb.HandleFunctionEvent(stream.FunctionData{ID: "tool123", Type: "call", Name: "test_tool", Input: longContent})
...
func TestFoldIndicatorColor(t *testing.T) {
	...
	wb.HandleFunctionEvent(stream.FunctionData{ID: "diff123", Type: "call", Name: "edit_file", Input: content.String()})
